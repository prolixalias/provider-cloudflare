...
type ScriptInitParameters struct {
	...
	// (Attributes) Configuration for Smart Placement. Specify either mode for Smart Placement, or one of region/hostname/host for targeted placement. (see below for nested schema)
